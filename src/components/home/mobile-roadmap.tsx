...
import { roadmapNodes, roadmapConfig, doubleLineDecorators } from "@/src/lib/data/roadmap-data";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-4 left-4 right-4 bg-[#FBFBFB] py-4 px-4">
          <motion.p
