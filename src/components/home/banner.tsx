...
function DesktopServiceCardIcon({
  ...
  const getIconConfig = () => {
    switch (iconType) {
      case "arr":
        return { src: DesktopArrIcon, width: 36, height: 47 };
      case "redd":
        return { src: DesktopReddIcon, width: 36, height: 47 };
      case "wrc":
        return { src: DesktopWrcIcon, width: 36, height: 47 };
      case "biochar":
        return { src: DesktopBiocharIcon, width: 36, height: 47 };
      default:
        return null;
    }
  };
...
function MobileServiceCardIcon({
  ...
  const getIconConfig = () => {
    switch (iconType) {
      case "arr":
        return { src: MobileArrIcon, width: 24, height: 24 };
      case "redd":
        return { src: MobileReddIcon, width: 24, height: 24 };
      case "wrc":
        return { src: MobileWrcIcon, width: 24, height: 24 };
      case "biochar":
        return { src: MobileBiocharIcon, width: 24, height: 24 };
      default:
        return null;
    }
  };
...
function DesktopServiceCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "bg-[#EEF0F2] w-full flex-shrink-0",
        "max-w-[280px] lg:max-w-[300px] xl:max-w-[340px] xxl:max-w-[400px] 2xl:max-w-[450px] 3xl:max-w-[470px]  3xl:max-h-[236px]",
        "p-4 lg:p-5 xl:p-6 xxl:p-7 2xl:p-8 3xl:px-6 3xl:pt-[35px] 3xl:pb-[61px]"
      )}
    >
        ...
        >
          ...
          >
            <h2
              className={cn(
                "text-[#1D2E27]",
                "md:font-['Open_Sans'] md:font-semibold text-[16px]",
                "xl:font-['Roboto'] xl:font-extrabold text-[15px]",
                "2xl:font-['Open_Sans'] 2xl:font-bold text-[14px]"
              )}
              style={{
                lineHeight:
          ...
          >
            <h3
              className={cn(
                "font-['Open_Sans'] text-[#5B5F58] text-center",
                "3xl:text-[12px] xxl:text-[11px] md:text-[14px]"
              )}
              style={{
                fontWeight: 600,
                lineHeight:
          ...
          <motion.div
            className={cn("flex-1 flex items-start justify-center")}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{
              duration: 0.95,
          ...
          >
            <p
              className={cn("font-['Open_Sans'] text-[#5B5F58] text-center")}
              style={{
                fontWeight: 400,
                fontSize:
...
export function Banner({
  ...
  const { isMobile, isTablet, isDesktop, isXxlScreen } = useResponsive();
  ...
  return (
    <div className="relative w-full h-[832px] md:h-[1050px] lg:h-[1200px] xl:h-[1440px] xxl:h-[1600px] 3xl:h-[1882px] overflow-hidden flex flex-col lg:mb-[40px]">
      {/* Mobile Background - Keep existing mobile layout */}
      {(!mounted || isMobile) && (
        <div className={cn("absolute inset-0 z-0", !mounted && "md:hidden")}>
          <Image
            src={BannerBgMobile}
      ...
      {(!mounted || isXxlScreen) && (
        <div
          className={cn(
            "absolute lg:top-[600px] xl:top-[680px] 2xl:top-[750px] 3xl:top-[1012px] 3xl:h-[870px] left-0 right-0 h-[920px] bg-[#FCFCFC] z-0 xxl:bg-amber-200",
      ...
      {(!mounted || isTablet) && (
        <div
          className={cn(
            "absolute inset-0 z-10 bg-[#FCFCFC] h-full",
            !mounted && "hidden md:block lg:hidden"
          )}
            ...
            >
              ...
              <div className="flex flex-col gap-6 md:gap-8">
                ...
                <motion.p
                  ...
                  className={cn("font-bold leading-[1.5] text-[#94A4B1]")}
                  style={{
                    fontFamily: "Open Sans",
                    fontWeight: "700",
      ...
      {(!mounted || isDesktop) && (
        <div
          className={cn("absolute inset-0 z-10", !mounted && "hidden lg:block")}
          style={{ pointerEvents: "none" }}
        >
          <Container maxWidth="full" padding="default" className="h-full">
            <div className="max-w-[1920px] mx-auto h-full">
              <div
                className={cn(
                  "grid h-full",
                  "3xl:!grid-cols-[120px_460px_100px_1fr] 3xl:!grid-rows-[411px_auto_116px_1fr]"
                )}
                style={{
                  gridTemplateColumns:
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    "lg:h-[350px] xl:h-[420px] xxl:h-[460px] 2xl:h-[520px]",
                    "3xl:h-[600px] 3xl:col-start-1 3xl:col-span-2"
                  )}
                >
                  <motion.div
                    {...SIMPLE_ANIMATIONS.fadeInLeft}
                    {...decoratorMotion}
                    transition={{ duration: 0.8, delay: 0.1, ease: "easeOut" }}
                    className="flex justify-start items-start h-full 3xl:-ml-5"
                  >
                    <Image
                      src={DesktopDecoratorIcon}
                      alt="Canopy Carbon decorator icon"
                ...
                <div className="col-start-4 row-start-2 lg:mr-[32px] xl:mr-[68px] xxl:mr-0 gap-[260px] 3xl:gap-[385px]">
                  <div className="gap-[10px] flex flex-col justify-start">
                    ...
                    <motion.h1
                      ...
                      className={cn(
                        "text-[#1E2E26]",
                        "text-[48px] lg:text-[52px] xl:text-[58px] xxl:text-[64px] 2xl:text-[72px] 3xl:text-[88px]",
                        "leading-[1.1] lg:leading-[56px] xl:leading-[62px] xxl:leading-[68px] 2xl:leading-[76px] 3xl:leading-[88px]",
                        "2xl:font-open-sans 3xl:font-avenir-heavy 3xl:font-normal"
                      )}
                      style={{
                        fontWeight: 550,
                      }}
                  ...
                  {/* Service Cards */}
                  {services && (
                    <div className="flex items-end mt-[48px] lg:mt-[200px] xl:mt-[230px] xxl:mt-[277px] 2xl:mt-[277px] 3xl:mt-[385px]">
                      <motion.div
                        {...SIMPLE_ANIMATIONS.fadeInUp}
                        transition={{
                          duration: 0.6,
                        ...
                        className={cn(
                          "grid grid-cols-2 grid-rows-2 w-full",
                          "max-w-[580px] lg:max-w-[620px] xl:max-w-[700px] xxl:max-w-[800px] 2xl:max-w-[900px] 3xl:max-w-[1000px]",
                          "gap-4 xl:gap-5 xxl:gap-6 2xl:gap-7 3xl:gap-10"
                        )}
                        style={{
                ...
                <div
                  className={cn(
                    "col-start-2 col-span-3 row-start-4 lg:ml-[120px]"
                  )}
                >
                  <motion.p
                    ...
                    className={cn(
                      "font-work-sans 3xl:font-avenir-heavy 3xl:font-normal font-semibold text-start",
                      "text-[18px] lg:text-[20px] xl:text-[22px] xxl:text-[24px] 2xl:text-[26px] 3xl:text-[33px]",
                      "leading-[28px] lg:leading-[30px] xl:leading-[32px] xxl:leading-[34px] 2xl:leading-[36px] 3xl:leading-[38px]",
                      "max-w-[600px] lg:max-w-[540px] xl:max-w-[630px] xxl:max-w-[745px] 3xl:max-w-[950px]"
                    )}
                    style={{
                      color: "#A1AEB9",
