              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7D8F89] focus:border-transparent text-[12px] lg:text-base"
                ...
                <div>
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7D8F89] focus:border-transparent resize-vertical text-[12px] lg:text-base"
                    style={{ fontFamily: "Open Sans", fontWeight: "600" }}
                    required
                  />
                </div>
